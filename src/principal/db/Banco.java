...
public class Banco {
    ...
    public static List<Estoque> produEstoques = new ArrayList<>();
    ...
    Produto produto = new Produto(1, "Pão", "Viscotti", new BigDecimal(4.99), 0326);
    ...
    Estoque estoque = new Estoque(produto, 10, "Setor 1");
